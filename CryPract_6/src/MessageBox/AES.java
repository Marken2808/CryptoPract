...
public class AES {
    ...
    public void letCheckAES(String messageToEncrypt) {
            ...
            System.out.println("Encrypted AES = " + Base64.getEncoder().encodeToString(encryptedText) ) ;
            ...
            System.out.println("Decrypted AES = " + new String(decryptedText)) ;
    ...
    private byte[] aesEncrypt(String message, SecretKey aesKey, GCMParameterSpec gcmParamSpec, byte[] aadData) {
            Cipher c = null ;
    ...
    private byte[] aesDecrypt(byte[] encryptedMessage, SecretKey aesKey, GCMParameterSpec gcmParamSpec, byte[] aadData) {
            Cipher c = null ;
